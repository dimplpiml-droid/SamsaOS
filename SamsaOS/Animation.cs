...
//                // Просто вызываем обработку кадра. 
//                // Если анимация завершена (метод вернул true), удаляем её из списка.
//                if (animator.ProcessFrame())
//                {
...
//            if (_startTime == 0)
//            {
//                _startTime = Cosmos.Core.CPU.GetCPUUptime();
//                FireStartAction();
//            }

//            double elapsedSeconds = (Cosmos.Core.CPU.GetCPUUptime() - _startTime) / 10000000000.0;
